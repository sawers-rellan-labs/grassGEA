...
dir <- "/Users/fvrodriguez/Projects/NCSU/06_GEA/GIS/predictors/source/raster"
...
# dir <- "/Users/fvrodriguez/Projects/NCSU/06_GEA/GIS/predictors/10km/raster"
# out_file <-"PH.tif"
# raster::writeRaster(
#   r,
#   filename = file.path(dir,out_file),
#   forrmat ="GTiff" #, overwrite=TRUE
# )

dir <- "/Users/fvrodriguez/Projects/NCSU/06_GEA/GIS/predictors/rfin/10km/raster"
file <-"PH.tif"
...
dir <- "/Users/fvrodriguez/Projects/NCSU/06_GEA/GIS/predictors/source/raster/metadata"
...
# dir <- "/Users/fvrodriguez/Desktop/LiMW_GIS_2015.gdb"
...
# I'll start with the 2018 NPP from modis
# But I want the "long term" average over 2001-2019 from this database:
# http://files.ntsg.umt.edu/data/NTSG_Products/MOD17/MODIS_250/modis-250-npp/
# http://files.ntsg.umt.edu/data/NTSG_Products/MOD17/MODIS_250/modis-250-npp/modis-250-npp-2018.tif

dir <- "/Users/fvrodriguez/Projects/NCSU/06_GEA/GIS/predictors/rfin/10km/raster"
file <-"modis-250-npp-2018.tif"
r <- raster(file.path(dir,file))
