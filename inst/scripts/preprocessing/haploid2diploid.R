...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# Changing Haploid alleles to Diploids                                       ----
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

haploid <-  read.csv(default_config$geno_file, sep = "\t")
diploid <- haploid
for (i in 1:nrow(haploid)){
  for (j in 12:ncol(haploid)){
    diploid[i,j] <- strrep(c[i,j],2)
  }
}

opts$diploid.hmp_output_file <- paste0(opts$diploid.hmp_prefix, "_",
                               opts$time_suffix,".RDS")

saveRDS(diploid, file.path(opts$output_dir, opts$diploid.hmp_output_file))
